...
import { MakeWindowTumblingTime } from './window.js'
import * as Inactivity from './inactivityCheck.js'
import Message from '../message/message.js'

export default function (task, storage, timeMilliSeconds, inactivityTimeMilliseconds = null) {
  const baseWindow = MakeWindowTumblingTime(storage)
